...
public final class TweetNaclFast {
	...
	public static final long []  D = new long [] {
    ...
    public static final long []  I = new long [] {
	...
	public static int crypto_verify_32(
			byte [] x, final int xoff, 
			byte [] y, final int yoff)
	{
