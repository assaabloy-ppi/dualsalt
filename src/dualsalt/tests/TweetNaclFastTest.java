...
public final class TweetNaclFastTest {
    ...
    public static final String BOX_MESSAGE = "be075fc53c81f2d5cf141316ebeb0c7b5228c52a4c62cbd44b66849b64244ffc"
            ...
            + "048977eb48f59ffd4924ca1c60902e52f0a089bc76897040e082f93776384864" + "5e0705";
    ...
    private boolean testBoxNonce() throws UnsupportedEncodingException {
        ...
        byte[] theNonce3 = TweetNaclFast.hexDecode(TweetNaclFast.hexEncodeToString(theNonce));
        Log.d(TAG,
                "BoxNonce Hex test Equal: " + "\"" + java.util.Arrays.equals(theNonce, theNonce3)
                        + "\"");
        String theNoncet = "";
    ...
    private boolean testSecretBox() throws UnsupportedEncodingException {
        ...
        for (int t = 0; t < 19; t++, m0 += m0) {
            ...
            /*
             * String mb0t = "mb0/"+mb0.length + ": "; for (int i = 0; i <
             * mb0.length; i ++) mb0t += " "+mb0[i]; Log.d(TAG, mb0t);
             */
            ...
            /*
             * String cabt = "cab/"+cab.length + ": "; for (int i = 0; i <
             * cab.length; i ++) cabt += " "+cab[i]; Log.d(TAG, cabt);
             */
            ...
            /*
             * String mbat = "mba/"+mba.length + ": "; for (int i = 0; i <
             * mba.length; i ++) mbat += " "+mba[i]; Log.d(TAG, mbat);
             */
    ...
    private boolean testSign() throws UnsupportedEncodingException {
        ...
        // peer A -> B
        TweetNaclFast.Signature pab = new TweetNaclFast.Signature(kb.getPublicKey(),
                ka.getSecretKey());

        // peer B -> A
        TweetNaclFast.Signature pba = new TweetNaclFast.Signature(ka.getPublicKey(),
                kb.getSecretKey());
        ...
        // self-signed
        TweetNaclFast.Signature pcc = new TweetNaclFast.Signature(kc.getPublicKey(),
                kc.getSecretKey());
